...
;savewoordenlijst("mywoorden.txt")
...
Function blue_ed(w,h,parent) ; main edit loop
	...
	; hmhm
	; buffy.nu?
	; she studies tea lint.
	; info swap.?
	; swap information to get new information.
	; based on deduction?
	; human logic
	; she drinks water coz the chance of her not drinking water is small
	; xsus..
	; 
	; any deductive information required?
	; i'm siggie
	; smoke.
	; inimsn
	; ze gaat 4 keer per dag naar de wc. met hite 8 keer. wat gemiddeld is
	; zal ongeveer wel kloppen.
	; inimsn
	; rudy:income and location and situation and human logic.
	; rudy..
	; exitmsn
	; ininote
	; facial expression and sound effect (motion detection)
	; exitnote
	; inimsn
	; random sammy in black... screen shine effect later.
	; exitms
	; 
	; 
	ma = 0
...
; and outside.
; 
; collect dust..50$ per time
; collect germs
; apearance.
; anti gravity . skin protection... age stay / age keep.
; no one as of yet.
; 
; ininote
; if you keep your jaw up
; for a duration of time (clock jaw)
; you could get noxious.
; This is caused by the liquid
; container in your head.
; It empties itself.
; endnote
; inimsn
; rudy>hiwhatp
; rudy>I wrote another note.
; rudy>in liquid and the body and effect.
; rudy>.
; rudy>yes.
; rudy>call your lawyer.
; rudy>tell me about the situation?
; rudy>hi?
; rudy>What is the problem?
; rudy>And?
; rudy>The situation is?
; rudy>
; exitmsn
;
; 
			...
			Case $103 	;- Key stroke (EDIT)
				...
				Select ed
					...
					Case 63275 ; end
						...
						End If
					Case 36
						savewoordenlijst("lijst"+MilliSecs()+".bb")
					Case 8 ; backspace
...
;
;ininote
; word processor head (15 year typehead)
;endnote
;
;
Function savewoordenlijst(a$)
	Notify CurrentDir()
	f = WriteFile(CurrentDir$()+"/"+a$)
	For i=0 To bluenumlines
		WriteLine f,blue$(i,0)
	Next
	CloseFile(f)
End Function
